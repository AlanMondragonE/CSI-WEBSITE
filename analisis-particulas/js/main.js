...
const initProductGallery = () => {
  ...
  const posterClimaVariable = $("#poster-2");
  ...
  const arrClimaVariable = [
    {
      src: "img/gallery/variable/MK/56-1900x800.jpg",
      responsive: "img/gallery/variable/MK/56-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MK</h1>
                  <p>Almacenamiento 60 Litros.</p>
              </div>`,
    },
    {
      src: "img/gallery/variable/MK/115-1900x800.jpg",
      responsive: "img/gallery/variable/MK/115-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MK</h1>
                  <p>Almacenamiento 115 Litros.</p>
              </div>`,
    },
    {
      src: "img/gallery/variable/MK/240-1900x800.jpg",
      responsive: "img/gallery/variable/MK/240-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MK</h1>
                  <p>Almacenamiento 228 Litros.</p>
              </div>`,
    },
    {
      src: "img/gallery/variable/MK/400-1900x800.jpg",
      responsive: "img/gallery/variable/MK/400-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MK</h1>
                  <p>Almacenamiento 417 Litros.</p>
              </div>`,
    },
    {
      src: "img/gallery/variable/MK/720-1900x800.jpg",
      responsive: "img/gallery/variable/MK/720-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MK</h1>
                  <p>Almacenamiento 734 Litros.</p>
              </div>`,
    },
    {
      src: "img/gallery/variable/MK/1020-1900x800.jpg",
      responsive: "img/gallery/variable/MK/1020-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MK</h1>
                  <p>Almacenamiento 991 Litros.</p>
              </div>`,
    },
    {
      src: "img/gallery/variable/MKT/115-1900x800.jpg",
      responsive: "img/gallery/variable/MKT/115-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKT</h1>
                  <p>Almacenamiento 115 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKT/240-1900x800.jpg",
      responsive: "img/gallery/variable/MKT/240-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKT</h1>
                  <p>Almacenamiento 228 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKT/720-1900x800.jpg",
      responsive: "img/gallery/variable/MKT/720-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKT</h1>
                  <p>Almacenamiento 734 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKF/56-1900x800.jpg",
      responsive: "img/gallery/variable/MKF/56-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKF</h1>
                  <p>Almacenamiento 60 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKF/115-1900x800.jpg",
      responsive: "img/gallery/variable/MKF/115-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKF</h1>
                  <p>Almacenamiento 115 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKF/240-1900x800.jpg",
      responsive: "img/gallery/variable/MKF/240-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKF</h1>
                  <p>Almacenamiento 228 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKF/400-1900x800.jpg",
      responsive: "img/gallery/variable/MKF/400-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKF</h1>
                  <p>Almacenamiento 417 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKF/720-1900x800.jpg",
      responsive: "img/gallery/variable/MKF/720-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKF</h1>
                  <p>Almacenamiento 734 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKF/1020-1900x800.jpg",
      responsive: "img/gallery/variable/MKF/1020-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKF</h1>
                  <p>Almacenamiento 991 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKFT/115-1900x800.jpg",
      responsive: "img/gallery/variable/MKFT/115-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKFT</h1>
                  <p>Almacenamiento 115 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKFT/240-1900x800.jpg",
      responsive: "img/gallery/variable/MKFT/240-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKFT</h1>
                  <p>Almacenamiento 228 Litros.</p>
              </div>`,
    ...
    {
      src: "img/gallery/variable/MKFT/720-1900x800.jpg",
      responsive: "img/gallery/variable/MKFT/720-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE MKFT</h1>
                  <p>Almacenamiento 734 Litros.</p>
              </div>`,
  ...
  const variableGallery = window.lightGallery(posterClimaVariable, {
    mode: "lg-fade",
    dynamic: true,
    plugins: [lgAutoplay, lgZoom, lgFullscreen],
    dynamicEl: arrClimaVariable,
    download: false,
    mobileSettings: {
      controls: true,
      showCloseIcon: true,
...
/*     constanteGallery.openGallery(0); */
  ...
  posterClimaVariable.addEventListener("click", () => {
/*     variableGallery.openGallery(0); */
  });
};
