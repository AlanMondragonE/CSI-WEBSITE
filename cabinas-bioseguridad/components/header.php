        ...
        <header class="header">
            ...
            <div class="header-video">
                <video loading="lazy" type="video/mp4" loop autoplay muted playsinline data-wf-ignore="true" data-object-fit="cover">
                    <source src="img/videos/bannerVid.mp4" data-wf-ignore="true" />
                </video>
                ...
                <div class="header-options">
                    <div class="btn-action">
                        ...
                        <div class="btn-action-content">
                            ...
                            <span class="btn-action-title">Clase II B2</span>
                        </div>
                    </div>
                    <div class="btn-action">
                        ...
                        <div class="btn-action-content">
                            ...
                            <span class="btn-action-title">Clase II A2</span>
                        </div>
                    </div>
                    <div class="btn-action">
                        ...
                        <div class="btn-action-content">
                            ...
                            <span class="btn-action-title">Clase II A2 libre de metales</span>
                        </div>
                    </div>
                    <div class="btn-action">
                        <span class="btn-action-icon"><i class="fas fa-snowflake"></i></span>
                        <div class="btn-action-content">
                            ...
                            <span class="btn-action-title">Clase II A2 Ecoline</span>
                        </div>
                    </div>
                </div>
            </div>
