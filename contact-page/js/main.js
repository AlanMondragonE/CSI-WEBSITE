...
const initCarrusels = () => {
  ...
  const config = {
    autoplay: true,
    type: 'loop', // Tipo de movimiento del carrusel
    perPage: 3, // Número de tarjetas visibles a la vez
    perMove: 1, // Número de tarjetas que se mueven al avanzar o retroceder
    ...
    breakpoints: {
      ...
      992: {
        perPage: 2, // Número de tarjetas visibles a la vez en pantallas medianas
      },
      600: {
        perPage: 1, // Número de tarjetas visibles a la vez en pantallas pequeñas
      },
    },
  };

  clsCore.initCarousel("splide", 1, config);
