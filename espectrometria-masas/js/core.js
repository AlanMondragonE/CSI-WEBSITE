...
export default class Core {
    ...
    */
    ...
    /**
     * Crear cookie de usuario en el sitio web.
     */
    ...
    createCookie(cookieName, cookieValue, expirationDays) {
        ...
        if (document.cookie) {
            document.querySelector('.cookies-container').classList.add('d-none');
        }

    }

    /**
     * Obtener cookies de usuario en el sitio web
     */
    ...
    /**
     * Valida las cookies del usuario
     */

    validateCookie(cookieName) {

        if (!this.getCookie(cookieName)) {

            $('.cookies-container').classList.remove('d-none');


        } else {
            $('.cookies-container').classList.add('d-none');
        }
