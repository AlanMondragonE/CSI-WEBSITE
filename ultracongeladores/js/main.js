  ...
  $(".header-options")
    ...
    .forEach((btn, index) => {
      btn.addEventListener("click", (e) => {
        if (index == 0) {
          window.scrollTo({
            top: $$(".bg-secondary-2")[0].offsetTop - 90,
            behavior: "smooth",
          });
        } else {
          window.scrollTo({
            top: $$(".bg-secondary-2")[1].offsetTop - 90,
            behavior: "smooth",
          });
        }
...
const initProductGallery = () => {
  const posterUltracongeladores = $("#poster-1");

  const arrUltracongeladores = [

    {
      src: "img/gallery/350_1900x800.jpg",
      responsive: "img/gallery/350_800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>UF V 350</h1>
                  <p>Bandejas de 3 a 13</p>
              </div>`,
    },
    {
      src: "img/gallery/477-1900x800.jpg",
      responsive: "img/gallery/477-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>UF V 500</h1>
                  <p>Bandejas de 3 a 13</p>
              </div>`,
    ...
    {
      src: "img/gallery/700-1900x800.jpg",
      responsive: "img/gallery/700-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>UF V 700</h1>
                  <p>Bandejas de 3 a 13</p>
              </div>`,
  ...
  const ultracongeladoresGallery = window.lightGallery(posterUltracongeladores, {
    mode: "lg-fade",
    dynamic: true,
    plugins: [lgAutoplay, lgZoom, lgFullscreen],
    dynamicEl: arrUltracongeladores,
    download: false,
    mobileSettings: {
      controls: true,
      showCloseIcon: true,
  ...
  posterUltracongeladores.addEventListener("click", () => {
       ultracongeladoresGallery.openGallery(0); 
  });
