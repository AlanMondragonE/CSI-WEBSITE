...
const initProductGallery = () => {
  ...
  const posterSeguridad = $("#poster-2");
  const posterVacio = $("#poster-3");

  const arrSecado = [
    {
      src: "img/gallery/calentamiento/M/56-1900x800.jpg",
      responsive: "img/gallery/calentamiento/M/56-1900x500.jpg 480",
    ...
    },
    {
      ...
      responsive: "img/gallery/calentamiento/M/115-1900x800.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE M</h1>
                  <p>Almacenamiento de 113 L - bandejas de 2 a 5 </p>
              </div>`,
    },
    {
      src: "img/gallery/calentamiento/M/260-1900x800.jpg",
      responsive: "img/gallery/calentamiento/M/260-1900x800.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE M</h1>
                  <p>Almacenamiento de 256 L - bandejas de 2 a 8 </p>
              </div>`,
    },
    {
      src: "img/gallery/calentamiento/M/720-1900x800.jpg",
      responsive: "img/gallery/calentamiento/M/720-1900x800.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE M</h1>
                  <p>Almacenamiento de 735 L - bandejas de 2 a 16 </p>
              </div>`,
    },
    {
      src: "img/gallery/calentamiento/FP/56-1900x800.jpg",
      responsive: "img/gallery/calentamiento/FP/56-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE FP</h1>
                  <p>Almacenamiento de 60 L - bandejas de 2 a 5 </p>
              </div>`,
      ecommerceURL: "https://www.inolabecommerce.com/product-detail/15"
    },
    {
      ...
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE FP</h1>
                  <p>Almacenamiento de 116 L - bandejas de 2 a 6 </p>
              </div>`,
      ecommerceURL: "https://www.inolabecommerce.com/product-detail/16"
    },
    {
      src: "img/gallery/calentamiento/FP/260-1900x800.jpg",
      responsive: "img/gallery/calentamiento/FP/260-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE FP</h1>
                  <p>Almacenamiento de 259 L - bandejas de 2 a 7 </p>
              </div>`,
    },
    {
  ...
  const arrSeguridad = [
    {
      src: "img/gallery/seguridad/FDL/115-1900x800.jpg",
      responsive: "img/gallery/seguridad/FDL/115-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE FDL</h1>
  ...
  const arrVacio = [
    {
      src: "img/gallery/vacio/VD/23-1900x800.jpg",
      responsive: "img/gallery/vacio/VD/23-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE VD</h1>
                  <p>Almacenamiento de 24 L - bandejas de 1 a 4 </p>
              </div>`,
    },
    {
      src: "img/gallery/vacio/VD/56-1900x800.jpg",
      responsive: "img/gallery/vacio/VD/56-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE VD</h1>
                  <p>Almacenamiento de 55 L - bandejas de 1 a 5 </p>
              </div>`,
    },
    {
      src: "img/gallery/vacio/VD/115-1900x800.jpg",
      responsive: "img/gallery/vacio/VD/115-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE VD</h1>
                  <p>Almacenamiento de 119 L - bandejas de 1 a 6  </p>
              </div>`,
    },
    {
      src: "img/gallery/vacio/VDL/23-1900x800.jpg",
      responsive: "img/gallery/vacio/VDL/23-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE VDL</h1>
                  <p>Almacenamiento de 24 L - bandejas de 2 a 4  </p>
              </div>`,
    },
    {
      src: "img/gallery/vacio/VDL/56-1900x800.jpg",
      responsive: "img/gallery/vacio/VDL/56-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE VDL</h1>
                  <p>Almacenamiento de 55 L - bandejas de 2 a 5  </p>
              </div>`,
    },
    {
      src: "img/gallery/vacio/VDL/115-1900x800.jpg",
      responsive: "img/gallery/vacio/VDL/115-800x500.jpg 480",
      subHtml: `<div class="lightGallery-captions">
                  <h1>SERIE VDL</h1>
                  <p>Almacenamiento de 119 L - bandejas de 2 a 6  </p>
              </div>`,
    }
  ];
  ...
  const seguridadGallery = window.lightGallery(posterSeguridad, {
    mode: "lg-fade",
    dynamic: true,
    plugins: [lgAutoplay, lgZoom, lgFullscreen],
    dynamicEl: arrSeguridad,
    download: false,
    mobileSettings: {
      controls: true,
      showCloseIcon: true,
  ...
  const vacioGallery = window.lightGallery(posterVacio, {
    mode: "lg-fade",
    dynamic: true,
    plugins: [lgAutoplay, lgZoom, lgFullscreen],
    dynamicEl: arrVacio,
  ...
  posterSeguridad.addEventListener("click", () => {
    seguridadGallery.openGallery(0);
  });

  posterVacio.addEventListener("click", () => {
    vacioGallery.openGallery(0);
  });
