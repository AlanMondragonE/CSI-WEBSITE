        ...
        <header class="header">
            ...
            <div class="header-video">
                <video loading="lazy" type="video/mp4" loop autoplay muted playsinline data-wf-ignore="true" data-object-fit="cover">
                    <source src="img/videos/laminarVid.mp4" data-wf-ignore="true" />
                </video>
                ...
                <div class="header-options">
                    <div class="btn-action">
                        ...
                        <div class="btn-action-content">
                            ...
                            <span class="btn-action-title">Cabina de Metal</span>
                        </div>
                    </div>
                    <div class="btn-action">
                        ...
                        <div class="btn-action-content">
                            ...
                            <span class="btn-action-title">Cabina de Polipropileno</span>
                        </div>
                    </div>
                    <div class="btn-action">
                        <span class="btn-action-icon"><i class="fas fa-tablets"></i></span>
                        <div class="btn-action-content">
                            ...
                            <span class="btn-action-title">Cabina de Polipropileno Eco</span>
                        </div>
                    </div>
                    <div class="btn-action">
                        <span class="btn-action-icon"><i class="fas fa-syringe"></i></span>
                        <div class="btn-action-content">
                            ...
                            <span class="btn-action-title">Cabina de Polipropileno IFV</span>
                        </div>
                    </div>
